...
import 'package:digital_bank/send_money.dart';
import 'package:flutter/material.dart';
import 'pin.dart';

class send_amount extends StatelessWidget {
    ...
    return WillPopScope(
        onWillPop: () async {
          ...
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => send_money()),
          );
          return false;
        },
        child: Scaffold(
